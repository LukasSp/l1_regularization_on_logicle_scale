...
folder_base = "models/"
model_name = "caroModel_logicle_1000"

petab_problem = petab.Problem.from_folder(folder_base + model_name)

petab_problem.model_name = 'caroModel_logicle_1000'
...
# test_par = obj.check_grad([1,1,1,1])
# print(test_par[np.array(['grad', 'fd_c', 'abs_err', 'rel_err'])])
...
save_startpoints(result=result, path='startpoints/', file_name='logicle')

# import startpoints
startpoints_import = import_startpoints('startpoints/logicle')
...
# specify path
path = 'results_and_plots/optimization/logicle5_1000/'
...
path_guess = 'guesses/logicle5_1000/'
...
path_guess = 'guesses/logicle5_1000/10'
x_guesses = import_guesses(path_guess)[0]

# define path for the results
path_ms = 'results_and_plots/modelSelection/logicle5_1000/'
