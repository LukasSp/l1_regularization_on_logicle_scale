...
folder_base = "models/"
model_name = "caroModel_logE_1"

petab_problem = petab.Problem.from_folder(folder_base + model_name)

petab_problem.model_name = 'caroModel_logE_1'
...
# CREATE OBJECTIVE FUNCTION ____________________________________________________________________________________________
...
save_startpoints(result=result, path='startpoints/', file_name='logE')

# import startpoints
startpoints_import = import_startpoints('startpoints/logE')
...
# specify path
path = 'results_and_plots/optimization/logE/'
...
path_guess = 'guesses/logE/1000'
x_guesses = import_guesses(path_guess)[0]

# define path for the results
path_ms = 'results_and_plots/modelSelection/logE/'
