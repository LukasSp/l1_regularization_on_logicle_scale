...
folder_base = "models/"
model_name = "Crauste_full_logE_1"

petab_problem = petab.Problem.from_folder(folder_base + model_name)

petab_problem.model_name = 'Crauste_full_logE_1'
...
# CREATE LOGE + 1 OBJECTIVE FUNCTION ___________________________________________________________________________________
...
save_startpoints(result=result, path='startpoints/', file_name='logE_1')
...
# specify path
path = 'results_and_plots/optimization/logE_1/'
...
path_guess = 'guesses/logE_1/10'
x_guesses = import_guesses(path_guess)[0]

# define path for the results
path_ms = 'results_and_plots/modelSelection/logE_1/'
