...
folder_base = "models/"
model_name = "Crauste_full_logE_eps"

petab_problem = petab.Problem.from_folder(folder_base + model_name)

petab_problem.model_name = 'Crauste_full_logE_eps'
...
# CREATE LOGE + eps OBJECTIVE FUNCTION _________________________________________________________________________________
...
path_guess = 'guesses/logE_eps/5000'
x_guesses = import_guesses(path_guess)[0]

# define path for the results
path_ms = 'results_and_plots/modelSelection/logE_eps/'
