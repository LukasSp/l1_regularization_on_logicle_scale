...
folder_base = "models/"
model_name = "Crauste_full_logicle5_100"

petab_problem = petab.Problem.from_folder(folder_base + model_name)

petab_problem.model_name = 'Crauste_full_logicle5_100'
...
save_startpoints(result=result, path='startpoints/', file_name='logicle5_100')
...
# specify path
path = 'results_and_plots/optimization/logicle5_100/'
...
path_guess = 'guesses/logicle5_100/'
...
path_guess = 'guesses/logicle5_100/5000'
x_guesses = import_guesses(path_guess)[0]

# define path for the results
path_ms = 'results_and_plots/modelSelection/logicle5_100/'
